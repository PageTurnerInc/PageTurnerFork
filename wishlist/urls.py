...
from wishlist.views import add_notes_flutter, add_to_wishlist, add_to_wishlist_flutter, delete_book_flutter, delete_note, delete_note_flutter,  show_wishlist,  delete_book, get_wishlist_items, add_notes, show_notes,get_notes
...
urlpatterns = [
    ...
    path('delete_note_flutter/', delete_note_flutter, name='delete_note_flutter'),
